...
namespace SEQ.Sim
{
    ...
    public class FpsCamera : AsyncScript
    {
        ...
        /// </summary>
        private CameraComponent Component => PlayerCamera.S.Camera;//Entity?.Get<CameraComponent>();
        ...
        private void UpdateViewMatrix()
        {
            ...
            var offset = CrosshairManager.GetCameraOffset() * 0.1f;

            var rotation = Quaternion.RotationYawPitchRoll(Yaw + offset.X, Pitch + offset.Y, 0);
